...
elm_peak_time = ${fparse elm_start_time + elm_ramp_time} #s
elm_end_time = ${fparse elm_peak_time + elm_ramp_time} #s
...
[Functions]
    [elm_time_function]
        ...
        expression = 'if(t_in_cycle < elm_start_time, 0,
                    ...
                    if(t_in_cycle < elm_end_time, (1 - (t_in_cycle-elm_peak_time)/elm_ramp_time),
                    0)))'
    []
